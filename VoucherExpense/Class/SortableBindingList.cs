...
namespace VoucherExpense
{
    public class SortableBindingList<T> : BindingList<T>
    {
        ...
        protected override bool IsSortedCore            { get  { return isSortedCore;  } }
        protected override ListSortDirection SortDirectionCore { get { return sortDirectionCore; } }
        protected override PropertyDescriptor SortPropertyCore { get { return sortPropertyCore;  } }
        ...
        protected override void RemoveSortCore()
        {
            if (isSortedCore)
            {
                ...
                sortDirectionCore = ListSortDirection.Ascending; Sort();
            }
        }
